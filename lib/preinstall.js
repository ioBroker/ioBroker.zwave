...
function installOpenZwaveFromSource() {
  ...
  doScript('cd open-zwave-master && make && sudo -S make install');
  // Add Patch 1125, needed for CentralScene Support
  doScript('curl -O -L https://github.com/OpenZWave/open-zwave/pull/1125.patch');
  doScript('patch -p1 < 1125.patch');
}
